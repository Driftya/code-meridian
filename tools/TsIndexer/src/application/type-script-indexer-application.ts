...
function logClassificationSummary(rootPath: string, projectName: string, sourceFiles: string[], docFiles: string[]): void {
  ...
  console.log(
    `  Classified ${files.length} indexed files for ${projectName}: ` +
