...
public sealed class FileRolePolicyTests
{
    ...
    [InlineData("tests/walker-test-helpers.ts", IndexedFileRole.Test)]
    [InlineData("tests/web/render-helper.tsx", IndexedFileRole.Test)]
    [InlineData("test/browser/fixture.js", IndexedFileRole.Test)]
    [InlineData("test/browser/fixture.jsx", IndexedFileRole.Test)]
    [InlineData("packages/orders/tests/helpers.ts", IndexedFileRole.Test)]
