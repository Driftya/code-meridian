...
- [ ] [P2 - Add Responsibility Slice Suggestions](docs/features/42-add-responsibility-slice-suggestions.md) - Suggest folder, namespace, and service extraction slices for large classes by clustering methods through graph evidence such as shared dependencies, callers, MCP tools, endpoints, CLI commands, DTOs, tests, docs, and architecture boundaries.
