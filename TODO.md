...
- [ ] [P2 - Prune Related-Knowledge Result Noise](docs/features/51-prune-related-knowledge-result-noise.md) - Collapse duplicate lexical matches and suppress weak keyword-only result soup.
- [ ] [P2 - Prune Optional Context Workflow Steps By Default](docs/features/52-prune-optional-context-workflow-steps.md) - Narrow tasks should not default to broad optional-step itineraries.
