...
- [ ] [P1 - Add Session Usefulness Evaluation](docs/features/17-add-session-usefulness-evaluation.md) - CodeMeridian should be able to answer whether it actually helped an implementation session
...
- [ ] [P2 - Improve Cross-Language Connection Quality](docs/features/19-improve-cross-language-connection-quality.md) - Current C# and TypeScript indexing share the graph, but true frontend-to-backend tracing needs stronger edges than imports and class relationships.
...
- [ ] [P2 - Add Change-Route Planning](docs/features/24-add-change-route-planning.md) - Give the AI an ordered edit path instead of a file dump.
...
- [ ] [P2 - Add Dependency Smell Paths](docs/features/33-add-dependency-smell-paths.md) - Surface architecture rule violations as graph paths.
...
- [ ] [P2 - Add Knowledge Decay Graph](docs/features/35-add-knowledge-decay-graph.md) - Turn stale-knowledge detection into a graph-native view.
